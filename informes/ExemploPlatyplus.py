...
miImagen = Image(os.path.relpath("/home/oracle/Imaxes/Captura de pantalla de 2021-12-13 17-54-42.png"), width=325, height=223)
elementos.append(miImagen)

doc = SimpleDocTemplate("exemploPlatypus.pdf", pagesize=A4, showBoundary=0, author="Braiskiskos")
doc.build(elementos)